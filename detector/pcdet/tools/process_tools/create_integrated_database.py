...
if __name__ == '__main__':
    ...
    parser.add_argument('--src_db_info', type=str, default='../../data/waymo_casa/waymo_processed_data_v0_5_0_waymo_dbinfos_train_sampled_1_multiframe_-4_to_0_tail_parallel.pkl', help='')
