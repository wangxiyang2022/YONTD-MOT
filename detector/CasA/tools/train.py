...
from detector.CasA.pcdet.config import cfg, cfg_from_list, cfg_from_yaml_file, log_config_to_file
from detector.CasA.pcdet.datasets import build_dataloader
from detector.CasA.pcdet import build_network, model_fn_decorator
...
def parse_config():
    ...
    parser.add_argument('--cfg_file', type=str, default="cfgs/waymo_models/CasA-V.yaml", help='specify the config for training')
