...
class OpenPCDetWaymoDetectionMetricsEstimator(tf.test.TestCase):
    WAYMO_CLASSES = ['unknown', 'Car', 'Vehicle', 'Pedestrian', 'Truck', 'Cyclist']
    ...
    def waymo_evaluation(self, prediction_infos, gt_infos, class_name, distance_thresh=100, fake_gt_infos=True):
        print('Start the waymo_casa evaluation...')
...
def main():
    ...
    parser.add_argument('--gt_infos', type=str, default='/home/data-ssd/waymo_casa/perception/waymo_infos_val.pkl', help='pickle file')
    ...
    print('Start to evaluate the waymo_casa format results...')
