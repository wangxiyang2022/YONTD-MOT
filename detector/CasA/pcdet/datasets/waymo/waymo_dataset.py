...
from detector.CasA.pcdet.datasets.waymo.waymo_eval import limit_period

sys.path.append(".../")
from detector.CasA.pcdet.ops.roiaware_pool3d import roiaware_pool3d_utils
# from ...ops.roiaware_pool3d import roiaware_pool3d_utils
from detector.CasA.pcdet.utils import box_utils, common_utils
...
class WaymoDataset(DatasetTemplate):
    ...
    def generate_prediction_dicts(batch_dict, pred_dicts, class_names, output_path=None):
        ...
        def generate_single_sample_dict(box_dict):
            if box_dict['pred_scores'].is_cuda:
