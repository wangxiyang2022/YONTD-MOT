...
from detector.TED.pcdet.datasets.augmentor.X_transform import X_TRANS
...
class TEDSHead(RoIHeadTemplate):
    ...
    def forward(self, batch_dict, trks=None):
        ...
        targets_dict = self.proposal_layer(
            batch_dict, trks, nms_config=self.model_cfg.NMS_CONFIG['TRAIN' if self.training else 'TEST']
        )
