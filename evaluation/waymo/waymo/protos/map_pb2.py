...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n#waymo_open_dataset/protos/map.proto\x12\x12waymo.open_dataset\"u\n\x03Map\x12\x34\n\x0cmap_features\x18\x01 \x03(\x0b\x32\x1e.waymo_casa.open_dataset.MapFeature\x12\x38\n\x0e\x64ynamic_states\x18\x02 \x03(\x0b\x32 .waymo_casa.open_dataset.DynamicState\"j\n\x0c\x44ynamicState\x12\x19\n\x11timestamp_seconds\x18\x01 \x01(\x01\x12?\n\x0blane_states\x18\x02 \x03(\x0b\x32*.waymo_casa.open_dataset.TrafficSignalLaneState\"\x8c\x03\n\x16TrafficSignalLaneState\x12\x0c\n\x04lane\x18\x01 \x01(\x03\x12?\n\x05state\x18\x02 \x01(\x0e\x32\x30.waymo_casa.open_dataset.TrafficSignalLaneState.State\x12\x30\n\nstop_point\x18\x03 \x01(\x0b\x32\x1c.waymo_casa.open_dataset.MapPoint\"\xf0\x01\n\x05State\x12\x16\n\x12LANE_STATE_UNKNOWN\x10\x00\x12\x19\n\x15LANE_STATE_ARROW_STOP\x10\x01\x12\x1c\n\x18LANE_STATE_ARROW_CAUTION\x10\x02\x12\x17\n\x13LANE_STATE_ARROW_GO\x10\x03\x12\x13\n\x0fLANE_STATE_STOP\x10\x04\x12\x16\n\x12LANE_STATE_CAUTION\x10\x05\x12\x11\n\rLANE_STATE_GO\x10\x06\x12\x1c\n\x18LANE_STATE_FLASHING_STOP\x10\x07\x12\x1f\n\x1bLANE_STATE_FLASHING_CAUTION\x10\x08\"\xda\x02\n\nMapFeature\x12\n\n\x02id\x18\x01 \x01(\x03\x12.\n\x04lane\x18\x03 \x01(\x0b\x32\x1e.waymo_casa.open_dataset.LaneCenterH\x00\x12\x31\n\troad_line\x18\x04 \x01(\x0b\x32\x1c.waymo_casa.open_dataset.RoadLineH\x00\x12\x31\n\troad_edge\x18\x05 \x01(\x0b\x32\x1c.waymo_casa.open_dataset.RoadEdgeH\x00\x12\x31\n\tstop_sign\x18\x07 \x01(\x0b\x32\x1c.waymo_casa.open_dataset.StopSignH\x00\x12\x32\n\tcrosswalk\x18\x08 \x01(\x0b\x32\x1d.waymo_casa.open_dataset.CrosswalkH\x00\x12\x33\n\nspeed_bump\x18\t \x01(\x0b\x32\x1d.waymo_casa.open_dataset.SpeedBumpH\x00\x42\x0e\n\x0c\x66\x65\x61ture_data\"+\n\x08MapPoint\x12\t\n\x01x\x18\x01 \x01(\x01\x12\t\n\x01y\x18\x02 \x01(\x01\x12\t\n\x01z\x18\x03 \x01(\x01\"\x82\x02\n\nLaneCenter\x12\x17\n\x0fspeed_limit_mph\x18\x01 \x01(\x01\x12\x35\n\x04type\x18\x02 \x01(\x0e\x32\'.waymo_casa.open_dataset.LaneCenter.LaneType\x12\x15\n\rinterpolating\x18\x03 \x01(\x08\x12.\n\x08polyline\x18\x08 \x03(\x0b\x32\x1c.waymo_casa.open_dataset.MapPoint\"]\n\x08LaneType\x12\x12\n\x0eTYPE_UNDEFINED\x10\x00\x12\x10\n\x0cTYPE_FREEWAY\x10\x01\x12\x17\n\x13TYPE_SURFACE_STREET\x10\x02\x12\x12\n\x0eTYPE_BIKE_LANE\x10\x03\"\xcd\x01\n\x08RoadEdge\x12\x37\n\x04type\x18\x01 \x01(\x0e\x32).waymo_casa.open_dataset.RoadEdge.RoadEdgeType\x12.\n\x08polyline\x18\x02 \x03(\x0b\x32\x1c.waymo_casa.open_dataset.MapPoint\"X\n\x0cRoadEdgeType\x12\x10\n\x0cTYPE_UNKNOWN\x10\x00\x12\x1b\n\x17TYPE_ROAD_EDGE_BOUNDARY\x10\x01\x12\x19\n\x15TYPE_ROAD_EDGE_MEDIAN\x10\x02\"\x88\x03\n\x08RoadLine\x12\x37\n\x04type\x18\x01 \x01(\x0e\x32).waymo_casa.open_dataset.RoadLine.RoadLineType\x12.\n\x08polyline\x18\x02 \x03(\x0b\x32\x1c.waymo_casa.open_dataset.MapPoint\"\x92\x02\n\x0cRoadLineType\x12\x10\n\x0cTYPE_UNKNOWN\x10\x00\x12\x1c\n\x18TYPE_BROKEN_SINGLE_WHITE\x10\x01\x12\x1b\n\x17TYPE_SOLID_SINGLE_WHITE\x10\x02\x12\x1b\n\x17TYPE_SOLID_DOUBLE_WHITE\x10\x03\x12\x1d\n\x19TYPE_BROKEN_SINGLE_YELLOW\x10\x04\x12\x1d\n\x19TYPE_BROKEN_DOUBLE_YELLOW\x10\x05\x12\x1c\n\x18TYPE_SOLID_SINGLE_YELLOW\x10\x06\x12\x1c\n\x18TYPE_SOLID_DOUBLE_YELLOW\x10\x07\x12\x1e\n\x1aTYPE_PASSING_DOUBLE_YELLOW\x10\x08\"H\n\x08StopSign\x12\x0c\n\x04lane\x18\x01 \x03(\x03\x12.\n\x08position\x18\x02 \x01(\x0b\x32\x1c.waymo_casa.open_dataset.MapPoint\":\n\tCrosswalk\x12-\n\x07polygon\x18\x01 \x03(\x0b\x32\x1c.waymo_casa.open_dataset.MapPoint\":\n\tSpeedBump\x12-\n\x07polygon\x18\x01 \x03(\x0b\x32\x1c.waymo_casa.open_dataset.MapPoint')
)
...
_TRAFFICSIGNALLANESTATE_STATE = _descriptor.EnumDescriptor(
  name='State',
  full_name='waymo_casa.open_dataset.TrafficSignalLaneState.State',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_LANECENTER_LANETYPE = _descriptor.EnumDescriptor(
  name='LaneType',
  full_name='waymo_casa.open_dataset.LaneCenter.LaneType',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_ROADEDGE_ROADEDGETYPE = _descriptor.EnumDescriptor(
  name='RoadEdgeType',
  full_name='waymo_casa.open_dataset.RoadEdge.RoadEdgeType',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_ROADLINE_ROADLINETYPE = _descriptor.EnumDescriptor(
  name='RoadLineType',
  full_name='waymo_casa.open_dataset.RoadLine.RoadLineType',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_MAP = _descriptor.Descriptor(
  name='Map',
  full_name='waymo_casa.open_dataset.Map',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='map_features', full_name='waymo_casa.open_dataset.Map.map_features', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='dynamic_states', full_name='waymo_casa.open_dataset.Map.dynamic_states', index=1,
...
_DYNAMICSTATE = _descriptor.Descriptor(
  name='DynamicState',
  full_name='waymo_casa.open_dataset.DynamicState',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='timestamp_seconds', full_name='waymo_casa.open_dataset.DynamicState.timestamp_seconds', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='lane_states', full_name='waymo_casa.open_dataset.DynamicState.lane_states', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TRAFFICSIGNALLANESTATE = _descriptor.Descriptor(
  ...
  full_name='waymo_casa.open_dataset.TrafficSignalLaneState',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='lane', full_name='waymo_casa.open_dataset.TrafficSignalLaneState.lane', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='state', full_name='waymo_casa.open_dataset.TrafficSignalLaneState.state', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='stop_point', full_name='waymo_casa.open_dataset.TrafficSignalLaneState.stop_point', index=2,
...
_MAPFEATURE = _descriptor.Descriptor(
  name='MapFeature',
  full_name='waymo_casa.open_dataset.MapFeature',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='waymo_casa.open_dataset.MapFeature.id', index=0,
      number=1, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='lane', full_name='waymo_casa.open_dataset.MapFeature.lane', index=1,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='road_line', full_name='waymo_casa.open_dataset.MapFeature.road_line', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='road_edge', full_name='waymo_casa.open_dataset.MapFeature.road_edge', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='stop_sign', full_name='waymo_casa.open_dataset.MapFeature.stop_sign', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='crosswalk', full_name='waymo_casa.open_dataset.MapFeature.crosswalk', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='speed_bump', full_name='waymo_casa.open_dataset.MapFeature.speed_bump', index=6,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='feature_data', full_name='waymo_casa.open_dataset.MapFeature.feature_data',
...
_MAPPOINT = _descriptor.Descriptor(
  name='MapPoint',
  full_name='waymo_casa.open_dataset.MapPoint',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='x', full_name='waymo_casa.open_dataset.MapPoint.x', index=0,
      number=1, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='y', full_name='waymo_casa.open_dataset.MapPoint.y', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='z', full_name='waymo_casa.open_dataset.MapPoint.z', index=2,
...
_LANECENTER = _descriptor.Descriptor(
  name='LaneCenter',
  full_name='waymo_casa.open_dataset.LaneCenter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='speed_limit_mph', full_name='waymo_casa.open_dataset.LaneCenter.speed_limit_mph', index=0,
      number=1, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='type', full_name='waymo_casa.open_dataset.LaneCenter.type', index=1,
      number=2, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='interpolating', full_name='waymo_casa.open_dataset.LaneCenter.interpolating', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='polyline', full_name='waymo_casa.open_dataset.LaneCenter.polyline', index=3,
...
_ROADEDGE = _descriptor.Descriptor(
  name='RoadEdge',
  full_name='waymo_casa.open_dataset.RoadEdge',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='waymo_casa.open_dataset.RoadEdge.type', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='polyline', full_name='waymo_casa.open_dataset.RoadEdge.polyline', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ROADLINE = _descriptor.Descriptor(
  name='RoadLine',
  full_name='waymo_casa.open_dataset.RoadLine',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='waymo_casa.open_dataset.RoadLine.type', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='polyline', full_name='waymo_casa.open_dataset.RoadLine.polyline', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_STOPSIGN = _descriptor.Descriptor(
  name='StopSign',
  full_name='waymo_casa.open_dataset.StopSign',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='lane', full_name='waymo_casa.open_dataset.StopSign.lane', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='position', full_name='waymo_casa.open_dataset.StopSign.position', index=1,
...
_CROSSWALK = _descriptor.Descriptor(
  name='Crosswalk',
  full_name='waymo_casa.open_dataset.Crosswalk',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='polygon', full_name='waymo_casa.open_dataset.Crosswalk.polygon', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SPEEDBUMP = _descriptor.Descriptor(
  name='SpeedBump',
  full_name='waymo_casa.open_dataset.SpeedBump',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='polygon', full_name='waymo_casa.open_dataset.SpeedBump.polygon', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
Map = _reflection.GeneratedProtocolMessageType('Map', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:waymo_casa.open_dataset.Map)
  })
...
DynamicState = _reflection.GeneratedProtocolMessageType('DynamicState', (_message.Message,), {
  ...
  '__module__' : 'waymo_open_dataset.protos.map_pb2'
  # @@protoc_insertion_point(class_scope:waymo_casa.open_dataset.DynamicState)
  })
...
TrafficSignalLaneState = _reflection.GeneratedProtocolMessageType('TrafficSignalLaneState', (_message.Message,), {
  ...
  '__module__' : 'waymo_open_dataset.protos.map_pb2'
  # @@protoc_insertion_point(class_scope:waymo_casa.open_dataset.TrafficSignalLaneState)
  })
...
MapFeature = _reflection.GeneratedProtocolMessageType('MapFeature', (_message.Message,), {
  ...
  '__module__' : 'waymo_open_dataset.protos.map_pb2'
  # @@protoc_insertion_point(class_scope:waymo_casa.open_dataset.MapFeature)
  })
...
MapPoint = _reflection.GeneratedProtocolMessageType('MapPoint', (_message.Message,), {
  ...
  '__module__' : 'waymo_open_dataset.protos.map_pb2'
  # @@protoc_insertion_point(class_scope:waymo_casa.open_dataset.MapPoint)
  })
...
LaneCenter = _reflection.GeneratedProtocolMessageType('LaneCenter', (_message.Message,), {
  ...
  '__module__' : 'waymo_open_dataset.protos.map_pb2'
  # @@protoc_insertion_point(class_scope:waymo_casa.open_dataset.LaneCenter)
  })
...
RoadEdge = _reflection.GeneratedProtocolMessageType('RoadEdge', (_message.Message,), {
  ...
  '__module__' : 'waymo_open_dataset.protos.map_pb2'
  # @@protoc_insertion_point(class_scope:waymo_casa.open_dataset.RoadEdge)
  })
...
RoadLine = _reflection.GeneratedProtocolMessageType('RoadLine', (_message.Message,), {
  ...
  '__module__' : 'waymo_open_dataset.protos.map_pb2'
  # @@protoc_insertion_point(class_scope:waymo_casa.open_dataset.RoadLine)
  })
...
StopSign = _reflection.GeneratedProtocolMessageType('StopSign', (_message.Message,), {
  ...
  '__module__' : 'waymo_open_dataset.protos.map_pb2'
  # @@protoc_insertion_point(class_scope:waymo_casa.open_dataset.StopSign)
  })
...
Crosswalk = _reflection.GeneratedProtocolMessageType('Crosswalk', (_message.Message,), {
  ...
  '__module__' : 'waymo_open_dataset.protos.map_pb2'
  # @@protoc_insertion_point(class_scope:waymo_casa.open_dataset.Crosswalk)
  })
...
SpeedBump = _reflection.GeneratedProtocolMessageType('SpeedBump', (_message.Message,), {
  ...
  '__module__' : 'waymo_open_dataset.protos.map_pb2'
  # @@protoc_insertion_point(class_scope:waymo_casa.open_dataset.SpeedBump)
  })
