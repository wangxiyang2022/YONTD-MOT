...
_LABEL_BOX_TYPE = _descriptor.EnumDescriptor(
  name='Type',
  full_name='waymo_casa.open_dataset.Label.Box.Type',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_LABEL_TYPE = _descriptor.EnumDescriptor(
  name='Type',
  full_name='waymo_casa.open_dataset.Label.Type',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_LABEL_DIFFICULTYLEVEL = _descriptor.EnumDescriptor(
  ...
  full_name='waymo_casa.open_dataset.Label.DifficultyLevel',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_LABEL_BOX = _descriptor.Descriptor(
  name='Box',
  full_name='waymo_casa.open_dataset.Label.Box',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='center_x', full_name='waymo_casa.open_dataset.Label.Box.center_x', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='center_y', full_name='waymo_casa.open_dataset.Label.Box.center_y', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='center_z', full_name='waymo_casa.open_dataset.Label.Box.center_z', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='length', full_name='waymo_casa.open_dataset.Label.Box.length', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='width', full_name='waymo_casa.open_dataset.Label.Box.width', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='height', full_name='waymo_casa.open_dataset.Label.Box.height', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='heading', full_name='waymo_casa.open_dataset.Label.Box.heading', index=6,
...
_LABEL_METADATA = _descriptor.Descriptor(
  name='Metadata',
  full_name='waymo_casa.open_dataset.Label.Metadata',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='speed_x', full_name='waymo_casa.open_dataset.Label.Metadata.speed_x', index=0,
      number=1, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='speed_y', full_name='waymo_casa.open_dataset.Label.Metadata.speed_y', index=1,
      number=2, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='accel_x', full_name='waymo_casa.open_dataset.Label.Metadata.accel_x', index=2,
      number=3, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='accel_y', full_name='waymo_casa.open_dataset.Label.Metadata.accel_y', index=3,
      number=4, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LABEL = _descriptor.Descriptor(
  name='Label',
  full_name='waymo_casa.open_dataset.Label',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='box', full_name='waymo_casa.open_dataset.Label.box', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='metadata', full_name='waymo_casa.open_dataset.Label.metadata', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='type', full_name='waymo_casa.open_dataset.Label.type', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='id', full_name='waymo_casa.open_dataset.Label.id', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='detection_difficulty_level', full_name='waymo_casa.open_dataset.Label.detection_difficulty_level', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='tracking_difficulty_level', full_name='waymo_casa.open_dataset.Label.tracking_difficulty_level', index=5,
...
_POLYGON2DPROTO = _descriptor.Descriptor(
  name='Polygon2dProto',
  full_name='waymo_casa.open_dataset.Polygon2dProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='x', full_name='waymo_casa.open_dataset.Polygon2dProto.x', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='y', full_name='waymo_casa.open_dataset.Polygon2dProto.y', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='id', full_name='waymo_casa.open_dataset.Polygon2dProto.id', index=2,
...
Label = _reflection.GeneratedProtocolMessageType('Label', (_message.Message,), dict(
  ...
  Box = _reflection.GeneratedProtocolMessageType('Box', (_message.Message,), dict(
    ...
    # @@protoc_insertion_point(class_scope:waymo_casa.open_dataset.Label.Box)
    ))
  ,
  ...
  Metadata = _reflection.GeneratedProtocolMessageType('Metadata', (_message.Message,), dict(
    ...
    __module__ = 'waymo_open_dataset.label_pb2'
    # @@protoc_insertion_point(class_scope:waymo_casa.open_dataset.Label.Metadata)
    ))
  ,
  DESCRIPTOR = _LABEL,
  __module__ = 'waymo_open_dataset.label_pb2'
  # @@protoc_insertion_point(class_scope:waymo_casa.open_dataset.Label)
  ))
...
Polygon2dProto = _reflection.GeneratedProtocolMessageType('Polygon2dProto', (_message.Message,), dict(
  ...
  __module__ = 'waymo_open_dataset.label_pb2'
  # @@protoc_insertion_point(class_scope:waymo_casa.open_dataset.Polygon2dProto)
  ))
